...
public class Main {private static  Employee[] employees = new Employee[10];
    ...
    public static void employeeMinSalary(Employee[] information) {
        ...
        for (int i = 0; i < information.length; i++) {
            if (information[i] != null)
                if (information[i].getSalaryEmployee()<minSalary)
    ...
    public static void employeeMaxSalary(Employee[] information) {
        ...
        for (int i = 0; i < information.length; i++) {
            if (information[i] != null)
                if (information[i].getSalaryEmployee()>maxSalary)
